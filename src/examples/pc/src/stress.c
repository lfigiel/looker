...
volatile size_t stat_bad_param;
volatile size_t stat_bad_comm;
volatile size_t stat_bad_state;
...
void stat_update(looker_exit_t err)
{
    switch (err) {
        ...
        case LOOKER_EXIT_NO_MEMORY:
            stat_no_memory++;
        break;
        case LOOKER_EXIT_BAD_PARAMETER:
            stat_bad_param++;
        break;
        case LOOKER_EXIT_BAD_COMMAND:
            stat_bad_comm++;
        break;
        case LOOKER_EXIT_BAD_STATE:
            stat_bad_state++;
        break;
